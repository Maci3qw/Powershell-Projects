...
$CurrentTS = Get-Date -Format "yyyyMMdd_HHmm_"
$LogFile = $CurrentTS + "Office_365_Licenses.csv" 
...
{     
    ...
    foreach ($user in $users) { 
       ...
       $datastring = ($user.lastname + " " + $user.firstname + ";" + $user.userprincipalname + ";" + $user.department + ";" + $license.SkuPartNumber) 
